...
In Input System 1.0.2, if the PlayerInput component has Auto tpPlace enabled, it will search the mobile device for connected devices; which is very costly and results in bad performance.
